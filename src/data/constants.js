...
export const experiences = [
  {
    id: 0,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIk5L7BRZcUkEUMsw_es8Q91dUCh-SGoWwOw&s",
    role: "Software Engineer Intern",
    company: "Precise Leads",
    date: "May 2024 - Present",
    desc: "Working on utilizing web scraping techniques to extract data from various sources and integrate it with Airtable and other databases using javavscript and react | Assisting with data cleaning, transformation, and normalization to ensure data accuracy and consistency | Developing automation using Zapier to simplify repetitive tasks and workflows across different tools.",
    skills: [
      "React",
      "JavaScript",
      "API Integration",
  ...
  //   date: "2023",
  //   desc: "contributed on Web Projects",
  //   skills: [
  //     "ReactJS",
  //     "Redux",
  //     "NodeJs",
...
export const education = [
  {
    id: 0,
    img: "https://pbs.twimg.com/profile_images/1714899115/Galgotia_University_400x400.png",
    school: "Galgotias College of Engineering and Technology, Greater Noida",
    date: "Nov 2021 - Sep 2025",
    grade: "7.84 CGPA",
    desc: "I am currently pursuing a Bachelor's degree in Computer Science and Engineering (DS) at Galgotias College of Engineering and Technology, Greater Noida. I have completed 5 semesters and have a CGPA of 7.84. I have taken courses in Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, Operating Systems, and Computer Networks, among others. I am also a member of the Google Developers Student Club (GDSC), where I am learning and working on exciting projects with a team of talented developers.",
    degree: "Bachelor of Technology - BTech, Computer Science and Engineering (Data Science)",
  },
  {
    id: 1,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxhnkyu9qhOnPQAxtT78W6fxoOhaEgmanHPQ&s",
    school: "Lucknow Pub School, Ahiyaraipur Raebareli",
    date: "2020",
    grade: "90.0%",
    desc: "I completed my class 12 high school education at Lucknow Pub School, Raebareli, where I studied Science with Computer Science.",
  ...
  },
  {
    ...
    date: "2018",
    grade: "88.4%",
    desc: "I completed my class 10 education at Lucknow Pub School, Raebareli.",
    degree: "CBSE(X)",
  },
];
...
export const projects = [
  {
    ...
    image:
      "https://cdn.buttercms.com/Dt1SRzdKSg6Dqejkm13p",
    tags: [
      "React",
      "CSS",
      "JavaScript",
  ...
  },
  {
    ...
    date: "In  Progress",
    description:
      "ReactJs, NodeJs, ExpressJs, MongoDB | Building a fully-functional E-commerce website with the MERN stack | Developing an interactive web app with an end-to-end user interface (UI) using React Bootstrap and Ant Design | Integrating firebase for handling authentication and redux for global state management.",
    image:
  ...
  },
  {
    ...
    image:
      "https://emeraude-escape.com//wp-content/uploads/2021/12/ee-treasurehunt-02-1920x864.png",
    tags: [
      "React Js",
      "Encoding techniques",
    ],
...
export const TimeLineData = [
  ...
  { year: 2022, text: "Work on basic skill" },
  { year: 2023, text: "Founded JavaScript Mastery" },
  { year: 2024, text: "work as intern in company" },
